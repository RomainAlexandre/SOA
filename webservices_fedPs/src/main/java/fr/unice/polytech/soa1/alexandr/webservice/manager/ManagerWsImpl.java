...
import fr.unice.polytech.soa1.alexandr.webservice.manager.inputs.ManagerQuery;
import fr.unice.polytech.soa1.alexandr.webservice.manager.outputs.*;
...
@WebService(targetNamespace = "http://informatique.polytech.unice.fr/soa1/romain/fedps/manager",
        ...
        endpointInterface = "fr.unice.polytech.soa1.alexandr.webservice.manager.ManagerWs")
